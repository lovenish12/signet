...
Given I navigate on to the "gordon" sites
And I take a screenshot of "gordon home page"
...
And I enter "watches" in the searchbox
...
And I click on product "1" available on PLP page
#And I take a screenshot of PDP page
And I click on add to shopping bag on PDP page on gordon
...
And I click on next button on shipping details page
