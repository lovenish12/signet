...
//_______________________________-webelements____________________________________________________//	
	...
	// Home Page
	 ...
	 //Login Page//*[@id="search_form_SearchBox_submit"]/span
	  ...
	  @FindBy(xpath="//img[contains(@title,'Adjustable Hashtag Symbol Toe Ring in Sterling Silver')]")
...
//Login Page Methods
	...
	public void clickProductImageOnPLP() {
		productImage.click();
	} 
	...
	*/
	...
	public void clickAddToCompareIcon() {
